    ...
    switch (action.type) {
        case actionTypes.GET_HOME:
            return {
                ...
                newEveryday: action.homeData?.find(item => item.sectionId === 'hEditorTheme') || {},
                top100: action.homeData?.find(item => item.sectionId === 'h100') || {},
                xone: action.homeData?.find(item => item.sectionId === 'hEditorTheme3') || {},
                ...
                favoritedArtist: action.homeData?.find(item => item.sectionId === '') || {},
